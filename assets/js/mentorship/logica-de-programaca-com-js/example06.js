function submitExample06(event, targetId) {
  ...
  return submitCodeGeneric(
    ...
    function () {
      ...
      return (
        (traduzir("en", "ola") === "Hello" && traduzir("pt", "ola") === "Olá") &&
        (traduzir("en", "tudo bem") === "How are you" && traduzir("pt", "tudo bem") === "Como você está")
      );
    },
    function () {
      var parag = document.createElement('p');
      parag.innerHTML = "EN: " + traduzir("en", "ola") + "! " + traduzir("en", "tudo bem") + "?"
      $form.appendChild(parag);

      var parag = document.createElement('p');
      parag.innerHTML = "PT: " + traduzir("pt", "ola") + "! " + traduzir("pt", "tudo bem") + "?"
      $form.appendChild(parag);
    }
  )
}
